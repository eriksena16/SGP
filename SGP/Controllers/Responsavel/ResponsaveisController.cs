...
namespace SGP.Controllers.Responsavel
{
    public class ResponsaveisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ResponsavelID,Nome")] Models.Responsaveis.Responsavel responsavel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ResponsavelID,Nome")] Models.Responsaveis.Responsavel responsavel)
        {
